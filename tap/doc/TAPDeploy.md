...
```
ytt -f clientRegistrationResourceClaim.yaml -v workloadNamespace=workloads -v appSSORedirectURI=acme-fitness.tap-next.blah.cloud/login/oauth2/code/sso | kubectl apply -f-
```
...
```
ytt -f ingress.yaml -v workloadNamespace=workloads -v appDomainName=tap-next.blah.cloud | kubectl apply -f-
```
